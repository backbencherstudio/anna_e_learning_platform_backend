...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['*', 'http://localhost:3000', 'http://localhost:4000', 'http://127.0.0.1:5500', 'https://anna-eagles-academy.vercel.app', 'https://match-toolbar-strengthen-railroad.trycloudflare.com'],
